...
public class Triangle extends AbstractShape
{
	...
	/**
	 * Return all information of triangle in String.
	 *
	 * @return description of triangle
	 */
	public String toString()
	{
		return String.format("Triangle at x=%d, y=%d with x=%d, y=%d and x=%d, y=%d", anchor.x, anchor.y, vertices.get(1).x, vertices.get(1).y, vertices.get(2).x, vertices.get(2).y);
	}
}
